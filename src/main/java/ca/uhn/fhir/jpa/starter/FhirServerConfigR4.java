...
public class FhirServerConfigR4 extends BaseJavaConfigR4 {
    ...
    @Bean()
    public IServerInterceptor hapiFhirSLSInterceptor() {
        System.out.println("INFO - INIT of SLS INTERCEPTOR");
        HapiFHIRSLSInterceptor retVal = new HapiFHIRSLSInterceptor();
        try { retVal.init(); } catch (Exception ex) { ex.printStackTrace(); }
        return retVal;
    }
