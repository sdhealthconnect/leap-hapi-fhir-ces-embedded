...
import com.cognitivemedicine.cm.security.hcs.interceptors.HapiFHIRSLSInterceptor;
import com.cognitivemedicine.cm.security.hcs.capability.FHIRDS4PCapabilityStatement;
...
public class JpaRestfulServer extends RestfulServer {
  ...
  protected void initialize() throws ServletException {
    ...
    /*
     * Register SLS Interceptor
     */

    HapiFHIRSLSInterceptor slsInterceptor = new HapiFHIRSLSInterceptor();
    try {
      slsInterceptor.init();
    } catch (IOException e) {
      e.printStackTrace();
    }
    this.registerInterceptor(slsInterceptor);
  ...
  public void setServerConformanceProvider(Object theServerConformanceProvider) {
    super.setServerConformanceProvider(new FHIRDS4PCapabilityStatement());
  }
}
